        ...
        function getTime() {
            ...
            return Time.query().$promise.then(function (results) {
                angular.forEach(results, function (result) {
                    ...
                    // move data into angular dateTime data.
                    result.start_time = result.start_time.substr(0, 10) + 'T' + result.start_time.substr(11, 8);
                    result.end_time = result.end_time.substr(0, 10) + 'T' + result.end_time.substr(11, 8);
                });
